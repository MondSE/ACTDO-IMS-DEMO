            ...
            <div class="row gx-1  flex flex-wrap">
                <div class="col-auto">
                    <label for="invoice" class="form-label">Invoice:</label>
                        <div class="input-group input-group-sm has-validation">
                            <input type="number" class="form-control border-dark-subtle" name="ticket_no" id="invoice" value="" placeholder="Ticket No." required>
                            <input type="number" class="form-control border-dark-subtle" name="official_receipt_no" id="invoice" value="" placeholder="Official Receipt" required>
                            <input type="date" class="form-control border-dark-subtle" name="data_transaction" id="invoice" value="" placeholder="Date Transaction" required>
                        </div>
                </div>
                ...
                <div class="col-auto">
                    <label for="payment_transaction" class="form-label">Payment Transaction:</label>
                        <div class="input-group input-group-sm has-validation">
                            <input type="number" class="form-control border-dark-subtle" name="original_amount_payment" id="payment_transaction" value="" placeholder="Original Amount" required>
                            <input type="number" class="form-control border-dark-subtle" name="discounted_amount_payment" id="payment_transaction" value="" placeholder="Discounted Amount" required>
                            <input type="text" class="form-control border-dark-subtle" name="discount_serial_no" id="payment_transaction" value="" placeholder="Discount Serial No." required>
                            <select class="form-select form-select-sm border-dark-subtle" name="transact_type" id="payment_transaction" required>
                            <option value="" selected>Transact select</option>
